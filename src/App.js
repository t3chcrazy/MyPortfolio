...
function App() {
  ...
  return (
    <div className="flex flex-col font-interSlab bg-white dark:bg-gray-900">
      <nav ref = {navRef} className = "z-50 shadow-md dark:shadow-md-white self-center bg-orange-500 fixed transition-transform transform w-screen px-auto flex flex-row justify-end md:p-4 p-2">
        <ModeSwitch />
      </nav>
      <main className = "container flex flex-col mx-auto text-bg-gray-800 dark:text-white">
        <div className = "flex flex-col container justify-center items-center lg:min-h-screen min-h-0 lg:pt-0 pt-48">
